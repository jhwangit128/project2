    ...
    Behavior.create([
      {
        ...
        treatment: "Provide your cat with lots of enrichment: toys, perches, and outdoor enclosures, as well as paper bags and boxes to explore. You may even think about getting your cat a kitty companion. Play with your cat for at least 10 minutes twice a day. Use dangly toys, balls, catnip toys, wadded up paper -- the sky's the limit. Don't encourage your cat to play with your hands or feet. Kittens who grow up playing with and nibbling on fingertips often grow up to be powerful cats who play bite -- hard! Don't punish your cat for play bites -- it's easy for kitty to interpret a slap as rough play, or to become afraid of you.",
        ...
        description: "Chronic licking in cats typically stems from pain or stress and anxiety. While all cats lick themselves, excessive licking may be serious and should be addressed without delay. A cat that's in pain may lick an area on its body until it's hairless and raw—and it isn’t always in the area that's causing pain. A stressed or anxious cat may lick its belly until it has no fur or obsessively overgroom other parts of its body.",
        treatment: "If you and your vet determine that there is no physical cause for your pet's behaviors, there are things you can do to improve your cat’s state of mind. Making sure your cat feels safe, loved, and comfortable in your home is important, as is providing adequate stimulation and exercise. You may find that desensitizing your cat by slowly and carefully exposing her to things she fears can be beneficial. Be careful to take baby steps if you try this so as not to overwhelm your cat and make the compulsive licking worse. Counter-conditioning, by training your cat to associate something pleasurable, like a treat, with something he fears may also help reduce stress and anxiety. Many times, boredom licking (also known as psychogenic alopecia) is improved by adding another cat or pet. But, there is always the risk that the second cat could be a new stress in your pet's environment that could make the hair loss worse.",
